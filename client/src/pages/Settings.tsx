...
type SettingGroup = "general" | "users" | "students" | "security" | "notifications" | "system";
...
const settingsFields: SettingField[] = [
  ...
  // Users
  {
    name: "Employee code generated by ",
    field_key: "employee_code_generated_by",
    setting_group: "users",
    type: "select",
    options: [
  ...
  // Students
  {
    name: "Student code generated by ",
    field_key: "student_code_generated_by",
    setting_group: "students",
    type: "select",
    options: [
      { label: "Auto", value: "auto" },
      { label: "Manual", value: "manual" },
  ...
  {
    name: "Student Code Prefix",
    field_key: "student_code_prefix",
    setting_group: "students",
    type: "text",
  },
  {
    name: "Student Code length",
    field_key: "student_code_length",
    setting_group: "students",
    type: "number",
  },
  // Security
